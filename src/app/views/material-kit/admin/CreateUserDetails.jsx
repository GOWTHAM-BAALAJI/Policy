...
export default function CreateUserDetails() {
    ...
    //         role_id: roleSum,
    //     }));
    // }, [initialuserID, initialempID, initialempName, initialempEmail, initialempMobile, initialdesignation, initialstate, clusterID, initialuserGroup, initialempStatus, roleSum]);
    ...
    //         }));
    //     }
    // }, [userID, empID, empName, empEmail, empMobile, roleSum, designation, state, clusterID, userGroup, empStatus]);
    ...
    const handleSubmit = async (event) => {
        ...
        if (!empID || !empName || !empEmail || (!empMobile && empMobile.length === 0) || (role.length === 0 && roleSum === 0) || !designation || userGroup === 0) {
                            ...
                            {selectedUser && (
                                <>
                                    ...
                                    <Grid container justifyContent="center" alignItems="center" sx={{ mt: 2 }}>
                                        <Button type="button" disabled={isBtnDisabled} variant="contained" sx={{ height: "30px", fontFamily: "sans-serif", fontSize: "0.875rem", backgroundColor: "#ee8812", "&:hover": { backgroundColor: "rgb(249, 83, 22)" } }}>
