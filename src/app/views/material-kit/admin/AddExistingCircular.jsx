...
const AddExistingCircular = () => {
    ...
    const handleTitleChange = (e) => {
        if (!(circulartitle === "" && e.target.value === " ")) setCircularTitle(e.target.value);
    };

    const handleDescriptionChange = (e) => {
        if (!(circulardescription === "" && e.target.value === " ")) setCircularDescription(e.target.value);
    };
    ...
    const handleSubmit = async (event) => {
        ...
        if ( !circulartitle.trimStart() || !circulardescription.trimStart() || !uploadFile || (selectedUserGroup.length === 0 && selectedUserGroupSum === 0)) {
        ...
        formData.append("title", circulartitle.trimStart());
        formData.append("description", circulardescription.trimStart());
        ...
        toast.promise(submitPromise, {
            loading: "Adding...",
            success: (data) => `Circular Added Successfully`,
                    ...
                    <Grid container spacing={2}>
                        <Grid item lg={12} md={12} sm={12} xs={12}>
                            <Typography variant="h5" sx={{ fontFamily: "sans-serif", fontSize: "1.4rem", marginLeft: { sm: 2, xs: 2 }, marginTop: { sm: 2, xs: 2 }, marginRight: { sm: 2, xs: 2 } }}>
                                Add an Existing Circular and Advisory
                            </Typography>
                        </Grid>
                                ...
                                <Grid item xs={9} sm={9} md={9} lg={9}>
                                    <Grid container alignItems="center" spacing={2}>
                                        <Grid item xs>
                                            <TextField
                                                ...
                                                variant="outlined"
                                                fullWidth
                                                placeholder="Enter the circular title"
                                    ...
                                    <Grid item xs={12} sx={{ textAlign: "right", marginTop: 1 }}>
                                        <Typography variant="body2" sx={{ fontFamily: "sans-serif", fontSize: "0.7rem" }}>
                                            {circulartitle.length}/100 characters
                                        </Typography>
                                    </Grid>
                                </Grid>
                            </Grid>
                        ...
                        <Grid item lg={12} md={12} sm={12} xs={12} sx={{ marginLeft: { sm: 2, xs: 2 }, marginRight: { sm: 2, xs: 2 } }}>
                            <Grid container alignItems="flex-start" spacing={2}>
                                ...
                                <Grid item xs={9} sm={9} md={9} lg={9}>
                                    <Grid container alignItems="center" spacing={2}>
                                        <Grid item xs>
                                            <TextField
                                                ...
                                                variant="outlined"
                                                fullWidth
                                                placeholder="Enter the circular description"
                                    ...
                                    <Grid item xs={12} sx={{ textAlign: "right", marginTop: 1 }}>
                                        <Typography variant="body2" sx={{ fontFamily: "sans-serif", fontSize: "0.7rem" }}>
                                            {circulardescription.length}/1000 characters
                                        </Typography>
                                    </Grid>
                                </Grid>
                            </Grid>
...
export default AddExistingCircular;
